  ...
  return (
    <div className="relative w-full h-full">
      ...
      >
        ...
        >
          <img
            src={mapMode === "satellite" ? "/img/e05e2849-1e91-4cbd-920e-5a0b1c6d67bf.jpg" : "/img/d0c13f47-3691-4960-b39d-1817ace51f30.jpg"}
            alt="GTA 5 Full Map"
        ...
        <div className="absolute top-4 left-4 bg-[#16213E]/90 backdrop-blur-sm rounded-lg p-3 border border-[var(--neon-pink)]/30 pointer-events-none z-10">
          <h3 className="neon-text-pink font-bold text-base sm:text-lg mb-1">GTA 5 Map</h3>
